...
\begin{itemize}
\item  Built and deployed machine learning models to predict the Diagnosis Related Group (DRG) for inpatient admissions. Within few months of its deployment, it has already saved more than 5 million dollars in hospital revenue. This project was selected as a finalist (in cost and efficiency category) at Mercy wide innovation conference. 
\item Built a NLP model based on deep learning to predict the diagnosis for inpatient admission from physician notes.
